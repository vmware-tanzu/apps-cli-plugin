...
func (noopClientGetter) ToRESTConfig() *rest.Config {
	return nil
}
...
func (noopClientGetter) ToRESTMapper() meta.RESTMapper {
	return nil
}
...
func NewBuilderFromClient(cd cli.Client, mapper meta.RESTMapper) *Builder {
	...
	// discovery.CachedDiscoveryInterface{discovery.DiscoveryInterface: cd.Discovery()}
	return newBuilder(
		cd.KubeRestConfig,
		cd.RESTMapper,
		(&cachingCategoryExpanderFunc{delegate: categoryExpanderFn}).ToCategoryExpander,
