...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MavenSourceType) DeepCopyInto(out *MavenSourceType) {
	*out = *in
	out.MavenSource = in.MavenSource
	if in.Type != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MavenSourceType.
func (in *MavenSourceType) DeepCopy() *MavenSourceType {
	if in == nil {
		return nil
	}
	out := new(MavenSourceType)
	in.DeepCopyInto(out)
	return out
}
